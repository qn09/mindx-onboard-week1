# Blog Application - Week 1: Deployment on Azure Kubernetes Service

**Project Overview:** A full-stack blog application with React frontend and Node.js backend, deployed on Azure Kubernetes Service (AKS) with OpenID Connect authentication and HTTPS/SSL.
...
```bash
# Build with docker-compose (optional)
...
### 5.2 Test Application (Before DNS)
...
- **Client Secret:** `<provided by MindX>`
...
**Next:** Continue to [Week 2: Monitoring & Analytics](WEEK2.md)
